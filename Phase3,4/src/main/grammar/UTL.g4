...
constructor returns [Constructor constructorRet]:{$constructorRet = new Constructor(null);}
    complexValue{$constructorRet.setName($complexValue.compTypeRet);} LPAREN (expression{$constructorRet.addArg($expression.expressionRet);}
    (COMMA expression{$constructorRet.addArg($expression.expressionRet);})*)? RPAREN;
...
expression returns [Expression expressionRet] :
    ...
    | constructor {$expressionRet = $constructor.constructorRet;}
    ;
