...
import main.ast.node.expression.VarAccess;
...
public class TypeChecker extends Visitor<Type> {
    ...
    public  Type visit(VarAccess varAccess){
        if (varAccess.getVariable().getName().equals("Ask")){
            return new FloatType();
        }
        else if (varAccess.getVariable().getName().equals("Bid")){
            return new FloatType();
        }
        return new NoType();
    }
    ...
    public Type visit(TradeValue value){return new TradeType();}
